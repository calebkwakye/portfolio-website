...
class About(models.Model):
    ...
    career = models.CharField(max_length=225)
...
class Portfolio(models.Model):
    ...
    technologies = models.CharField(max_length=500, default='')  
    #video_url = models.URLField(max_length=200, blank=True, null=True)  # Add the video URL, allowing blank and null values
